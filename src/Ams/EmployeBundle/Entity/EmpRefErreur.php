 ...
 * EmpRefErreur
 *
 * @ORM\Table(name="emp_ref_erreur"
 *            ,indexes={@ORM\Index(name="idx1_emp_ref_erreur", columns={"rubrique","code"})
 *                     }
 *          )
 * @ORM\Entity(repositoryClass="Ams\ModeleBundle\Repository\EmpRefErreurRepository")
 */
class EmpRefErreur {
