...
class RefTransportController extends GlobalReferentielController {

    public function getRepositoryName() { return $this->getBundleName().':RefTransport'; }

    public function gridAction() {
        $em = $this->getDoctrine()->getManager();
        $isModif=$this->isPageElement('MODIF','liste_pai_reftransport');
