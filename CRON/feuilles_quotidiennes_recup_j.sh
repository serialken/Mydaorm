...
# identifiant du sh
id_sh='feuilles_quotidiennes_recup_j'
...
echo '<pre>'
php ./app/console classement_auto J+0 J+0 --flux=C_A_S --jn=nuit --nbmax=10000 --id_sh=$id_sh --id_ai=$id_ai --env=$env > $fic_log 2>&1
cat $fic_log
echo '</pre>'
echo '<br /><br />'
...
echo '<pre>'
php ./app/console feuille_emargement all 1 J+0 --id_sh=$id_sh --id_ai=$id_ai --env=$env > $fic_log 2>&1
cat $fic_log
echo '</pre>'
echo '<br /><br />'
...
echo '<pre>'
php ./app/console feuille_emargement all 2 J+0 --id_sh=$id_sh --id_ai=$id_ai --env=$env > $fic_log 2>&1
cat $fic_log
echo '</pre>'
echo '<br /><br />'
...
echo '<pre>'
php ./app/console feuille_portage --flux=1 J+0 J+0 --id_sh=$id_sh --id_ai=$id_ai --env=$env > $fic_log 2>&1
cat $fic_log
echo '</pre>'
echo '<br /><br />'
