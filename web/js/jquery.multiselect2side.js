				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__options'>" +
							...
							?
							("<p class='AddOne' title='Ajouter &agrave; la s&eacute;lection'>&rsaquo;</p>" +
							"<p class='AddAll' title='Ajouter tout'>&raquo;</p>" +
							"<p class='RemoveOne' title='Enlever de la s&eacute;lection'>&lsaquo;</p>" +
							"<p class='RemoveAll' title='Enlever tout'>&laquo;</p>")
							:
							("<p class='AddOne' title='Ajouter &agrave; la s&eacute;lection'>&lsaquo;</p>" +
							"<p class='AddAll' title='Ajouter tout'>&laquo;</p>" +
							"<p class='RemoveOne' title='Enlever de la s&eacute;lection'>&rsaquo;</p>" +
							"<p class='RemoveAll' title='Enlever tout'>&raquo;</p>")
							) +
						"</div>" +
						"<div class='ms2side__select'>" +
