...
class PaiRefPostePaieSupplementController extends GlobalPaiController {

    public function getRepositoryName() { return $this->getBundleName().':PaiRefPostePaieSupplement'; }

    public function getRoute() {
        return 'liste_pai_refpostepaiesupplement';
    }
