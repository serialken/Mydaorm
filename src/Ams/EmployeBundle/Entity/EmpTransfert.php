 ...
 * EmpTransfert
 *
 * @ORM\Table(name="emp_transfert"
 *                ,uniqueConstraints={@ORM\UniqueConstraint(name="un_emp_transfert", columns={"contrat_id","date_debut"})}
 *              )
 * @ORM\Entity(repositoryClass="Ams\EmployeBundle\Repository\EmpTransfertRepository")
*/
class EmpTransfert
{
    /**
