...
class PaiDiffuseurController extends GlobalPaiController {
    protected $natureclient_id=1;

    public function getRepositoryName() { return $this->getBundleName().':PaiDiffuseur'; }
    public function getServiceName() { return 'ams.repository.paidiffuseur'; }
    public function getRoute() { return 'liste_pai_diffuseur'; }
