...
echo '<h3><u>Export des comptes rendus de reception JOUR vers DAN JADE</u></h3>'
echo '<pre>'
php ./app/console cr_reception_export JADE_EXP_CR_RECEPTION J+0 J+0 --pqr_id=59 --jn=jour --soc=MD,MP --id_sh=$id_sh --id_ai=$id_ai --env=$env > $fic_log 2>&1
cat $fic_log
echo '</pre>'
echo '<br /><br />'
