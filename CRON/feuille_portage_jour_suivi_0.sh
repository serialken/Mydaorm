...
########## Verification de la presence des feuilles de portage jour J+0
...
# identifiant du sh
id_sh='feuille_portage_jour_suivi'
...
#*-*-*-*-*- Verification de la presence des feuilles de portage Jour J+0
echo '<h3><u>Verification de la presence des feuilles de portage Jour J+0</u></h3>'
echo '<pre>'
php ./app/console feuille_portage_suivi J+0 J+0 --jn=jour --id_sh=$id_sh --id_ai=$id_ai --env=$env > $fic_log 2>&1
cat $fic_log
echo '</pre>'
echo '<br /><br />'
