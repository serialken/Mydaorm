...
/**
 * 
 * Alimentation des employes à partir de PleiadesNG.
 *
 */
class AlimentationEmployeCommand extends GlobalCommand {

    protected function configure() {
        $this->sNomCommande = 'alimentation_employe';
        $this->setName($this->sNomCommande);
        $this->setDescription('Alimentation des employ&eacute;s a partir de PleiadesNG.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        $this->oLog->info($dateDebut->format('H:i:s') . "   \tD&eacute;but de l'alimentation des employ&eacute;s.");

        try {
            $this->getContainer()->get('PleiadesNG')->alimentation($idtrt, $utilisateur_id);
        ...
        $this->endTraitement();
        $dateDebut = new \DateTime();
        $this->oLog->info($dateDebut->format('H:i:s') . "   \tFin de l'alimentation des employ&eacute;s.");
