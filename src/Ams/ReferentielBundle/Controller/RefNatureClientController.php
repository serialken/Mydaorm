...
class RefNatureClientController extends GlobalReferentielController {

    public function getRepositoryName() { return $this->getBundleName().':RefNatureClient'; }

    public function gridAction() {
        $em = $this->getDoctrine()->getManager();
        $isModif=$this->isPageElement('MODIF','liste_pai_refnatureclient');
