...
CENTRE_DISTRIB=(036 039 040 041 042 045 050 051)
...
php $racine_projet/app/console feuille_portage_suivi J$JOUR J$JOUR --jn=$JOUR_NUIT --dest="andry.andrianiaina@amaury.com" --id_sh=$id_sh --id_ai=$id_ai --env=$env >> $fic_log 2>&1
#php $racine_projet/app/console feuille_portage_suivi J$JOUR J$JOUR --jn=$JOUR_NUIT --id_sh=$id_sh --id_ai=$id_ai --id_sh=$id_sh --id_ai=$id_ai --env=$env >> $fic_log 2>&1
echo '</pre>' >> $fic_log 2>&1
