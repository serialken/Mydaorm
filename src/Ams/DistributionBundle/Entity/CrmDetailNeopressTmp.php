 ...
 *
 * @ORM\Table(name="crm_detail_neopress_tmp", indexes={@Index(name="idx_date_export", columns={"date_export"})
 *                                              , @Index(name="idx_numaboext_soc", columns={"numabo_ext","soc_code_ext"})
 *                                                      }
 *              )
 * @ORM\Entity(repositoryClass="Ams\DistributionBundle\Repository\CrmDetailNeopressTmpRepository")
 */
class CrmDetailNeopressTmp
{
    /**
     * @var integer
     *
    ...
    /**
     * code produit neopress
     * @var \string
     *
     * @ORM\Column(name="prd_code_neopress", type="string", nullable=true)
     */
