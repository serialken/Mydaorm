...
/**
 * FranceRoutageClientsAServirTmp
 *
 * @ORM\Table(name="france_routage_c_a_s_tmp", indexes={@index(name="idx_modele_tournee_jour_code", columns={"modele_tournee_jour_code"})
 *                                                      , @index(name="idx_abonne", columns={"numabo_ext", "soc_code_ext"})
 *                                                      , @index(name="idx_dat_soc", columns={"date_distrib", "soc_code_ext"})
 *                                                      , @index(name="idx_adresse_insee", columns={"rnvp_vol4", "rnvp_insee"})
 ...
 *                                                      , @index(name="idx_cp", columns={"cp_ext"})
 *                                                      , @index(name="idx_date_distrib", columns={"date_distrib"})
 *                                                      
 *                                                      }
 *          )
 * @ORM\Entity(repositoryClass="Ams\DistributionBundle\Repository\FranceRoutageClientsAServirTmpRepository")
 */
class FranceRoutageClientsAServirTmp
{
    /**
     * @var integer
     *
     ...
     * 'PRD_INCONNU' : Produit inconnu (non parametre)
    ...
    /**
     * @var string
     * @ORM\Column(name="modele_tournee_jour_code", type="string", nullable=true)
     */
