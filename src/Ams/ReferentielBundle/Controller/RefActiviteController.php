...
class RefActiviteController extends GlobalReferentielController {

    public function getRepositoryName() { return $this->getBundleName().':RefActivite'; }

    public function gridAction() {
        $em = $this->getDoctrine()->getManager();
        $isModif=$this->isPageElement('MODIF','liste_pai_refactivite');
