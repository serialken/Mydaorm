...
class PaiRefPostePaieGeneralController extends GlobalPaiController {

    public function getRepositoryName() {
        return $this->getBundleName() . ':PaiRefPostePaieGeneral';
    }

    public function getRoute() {
        return 'liste_pai_refpostepaiegeneral';
    }
