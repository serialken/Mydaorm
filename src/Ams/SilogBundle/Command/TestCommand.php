...
class TestCommand extends GlobalCommand
{
    protected function configure()
    {
    	$this->sNomCommande	= 'test_command';
    	$this->setName($this->sNomCommande);
    	// Pour executer, faire : php app/console test_command --maj 10.151.93.3 sdvp sdvp "/FTPJADE/fic_test.txt" "./fic_test.txt"
        $this
