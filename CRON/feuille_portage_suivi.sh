...
#*-*-*-*-*- Verification de la presence des feuilles de portage
echo '<h3><u>Verification de la presence des feuilles de portage</u></h3>'
echo '<pre>'
php ./app/console feuille_portage_suivi J+1 J+1 --id_sh=$id_sh --id_ai=$id_ai --env=$env > $fic_log 2>&1
cat $fic_log
echo '</pre>'
echo '<br /><br />'
