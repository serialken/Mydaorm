...
########## Verification de la presence des feuilles de portage jour de J+1
...
# identifiant du sh
id_sh='feuille_portage_jour_suivi_1'
...
#*-*-*-*-*- Verification de la presence des feuilles de portage Jour J+1
echo '<h3><u>Verification de la presence des feuilles de portage Jour J+1</u></h3>'
echo '<pre>'
php ./app/console feuille_portage_suivi J+1 J+1 --jn=jour --id_sh=$id_sh --id_ai=$id_ai --env=$env > $fic_log 2>&1
cat $fic_log
echo '</pre>'
echo '<br /><br />'
