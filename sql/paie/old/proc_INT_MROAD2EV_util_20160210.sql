...
END;
 ...
 -- ------------------------------------------------------------------------------------------------------------------------------------------------
DROP PROCEDURE IF EXISTS int_mroad2ev_reinit_employe;
CREATE PROCEDURE int_mroad2ev_reinit_employe(
    IN 	  _date_extrait		DATETIME,
    IN    _employe_id     INTEGER)
BEGIN
  update pai_journal set date_extrait=null where date_extrait=_date_extrait and employe_id=_employe_id;
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Réinitalisation du journal employé');
...
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Réinitalisation du journal tournée');
...
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Réinitalisation du journal activité');
  update pai_incident set date_extrait=null where date_extrait=_date_extrait and employe_id=_employe_id;
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Réinitalisation des incidents');
...
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Réinitalisation des réclamations');
...
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Réinitalisation des produits');
  update pai_tournee set date_extrait=null where date_extrait=_date_extrait and employe_id=_employe_id;
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Réinitalisation des tournées');
  update pai_activite set date_extrait=null where date_extrait=_date_extrait and employe_id=_employe_id;
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Réinitalisation des activités');
  update pai_majoration set date_extrait=null where date_extrait=_date_extrait and employe_id=_employe_id;
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Réinitalisation des majorations');
  delete from pai_stc where date_extrait=_date_extrait and employe_id=_employe_id;
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Réinitalisation des STC');

  delete from pai_activite where date_extrait=_date_extrait and activite_id=-10 and employe_id=_employe_id;
--  call int_logrowcount_C(_idtrt,4,'int_mroad2ev_reinit_employe','Suppression complément heures garanties');
END;
...
CREATE PROCEDURE int_mroad2ev_historise_employe(
  ...
  INSERT INTO pai_ev_emp_depot_hst(employe_id, depot_id, flux_id, matricule, dRC, fRC, dCtr, fCtr, d, f, rc, /*nbkm_paye, nbcli,*/ idtrt) 
  SELECT employe_id, depot_id, flux_id, matricule, dRC, fRC, dCtr, fCtr, d, f, rc, /*nbkm_paye, nbcli,*/ _idtrt
  FROM pai_ev_emp_depot;
  call int_logrowcount_C(_idtrt,5,'int_mroad2ev_historise_employe','pai_ev_emp_depot_hst');
  INSERT INTO pai_ev_emp_pop_hst(employe_id, emploi_code, societe_id, matricule, dRC, fRC, dCtr, fCtr, d, f, rc, nbabo, qualite, nbrec, taux, idtrt) 
  SELECT employe_id, emploi_code, societe_id, matricule, dRC, fRC, dCtr, fCtr, d, f, rc, nbabo, qualite, nbrec, taux, _idtrt
  FROM pai_ev_emp_pop;
  call int_logrowcount_C(_idtrt,5,'int_mroad2ev_historise_employe','pai_ev_emp_pop_hst');
  INSERT INTO pai_ev_emp_pop_depot_hst(employe_id, depot_id, flux_id, population_id, typetournee_id, societe_id, matricule, dRC, fRC, dCtr, fCtr, d, f, rc, idtrt) 
  SELECT employe_id, depot_id, flux_id, population_id, typetournee_id, societe_id, matricule, dRC, fRC, dCtr, fCtr, d, f, rc, _idtrt
...
CREATE PROCEDURE int_mroad2ev_historise_ev(
  ...
  INSERT INTO pai_ev_activite_hst(id, depot_id, flux_id, employe_id, activite_id, typejour_id, jour_id, date_distrib, duree, duree_nuit, duree_garantie, nbkm_paye, qte, idtrt) 
  SELECT id, depot_id, flux_id, employe_id, activite_id, typejour_id, jour_id, date_distrib, duree, duree_nuit, duree_garantie, nbkm_paye, qte, _idtrt
  FROM pai_ev_activite;
  call int_logrowcount_C(_idtrt,5,'int_mroad2ev_historise_ev','pai_ev_activite_hst');
  INSERT INTO pai_ev_tournee_hst(id, depot_id, flux_id, employe_id, typejour_id, jour_id, date_distrib, code, nbkm_paye, duree, duree_nuit, duree_autre, nbcli, nbrep, valrem, valrem_corrigee, majoration, majoration_nuit, duree_nuit_modele, idtrt, transport_id) 
  SELECT id, depot_id, flux_id, employe_id, typejour_id, jour_id, date_distrib, code, nbkm_paye, duree, duree_nuit, duree_autre, nbcli, nbrep, valrem, valrem_corrigee, majoration, majoration_nuit, duree_nuit_modele, _idtrt, transport_id
  FROM pai_ev_tournee;
  call int_logrowcount_C(_idtrt,5,'int_mroad2ev_historise_ev','pai_ev_tournee_hst');
  INSERT INTO pai_ev_produit_hst(id, tournee_id, produit_id, natureclient_id, typeurssaf_id, typeproduit_id, qte, nbcli, nbrep, duree_supplement, pai_qte, pai_taux, pai_val, idtrt) 
  SELECT id, tournee_id, produit_id, natureclient_id, typeurssaf_id, typeproduit_id, qte, nbcli, nbrep, duree_supplement, pai_qte, pai_taux, pai_val, _idtrt
  FROM pai_ev_produit;
  call int_logrowcount_C(_idtrt,5,'int_mroad2ev_historise_ev','pai_ev_produit_hst');
  INSERT INTO pai_ev_reclamation_hst(id, tournee_id, nbrec_abonne, nbrec_diffuseur, idtrt) 
  SELECT id, tournee_id, nbrec_abonne, nbrec_diffuseur, _idtrt
