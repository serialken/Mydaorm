 ...
 * Represents a string.
 * 
 * http://code.google.com/p/php-string/
 */
class String /*implements Iterator, ArrayAccess, Countable*/
{
     ...
     * @var bool
     */
    protected static $_extMbstring = null;
     ...
     * @var bool
     */
    protected static $_extIconv = null;
     ...
     * @var bool
     */
    protected static $_extUtf8 = null;
    ...
    {
        if (!is_callable($name)) {
            throw new Exception('$name is not a valid callback.');
        }
    ...
    {
        if (empty($args)) {
            throw new \Exception('Static callback requires at least one parameter.');
        }
