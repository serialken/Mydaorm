...
*/ 
  ...
  SELECT 
      concat('<a href="javascript:goLinkGrid(''../etalon/liste-etalon?'',''depot_id=',me.depot_id,'&flux_id=',me.flux_id,'&etalon_id=',me.id,''');" data-content="lien" onMouseOver="affPopoverLien(this)"><img src="/images/dhtmlx_contrat.png"></a>') as "Lien__ro__false__50__center__str",
